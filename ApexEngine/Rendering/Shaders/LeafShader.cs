...
namespace ApexEngine.Rendering.Shaders
{
    public class LeafShader : Shader
    {
        ...
        public override void ApplyMaterial(Material material)
        {
            ...
            float treeHeight = material.GetFloat("tree_height");
            this.SetUniform("u_treeHeight", treeHeight);
