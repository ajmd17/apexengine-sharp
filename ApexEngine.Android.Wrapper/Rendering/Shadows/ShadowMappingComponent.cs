...
namespace ApexEngine.Rendering.Shadows
{
    public class ShadowMappingComponent : RenderComponent
    {
        ...
        protected float[] splits = new float[] { 10f, 20f, 30f, 40f };
        ...
        public ShadowMappingComponent(Camera cam, Environment environment) : this(cam, environment, new int[] { 1024, 1024 })
        {
        }
