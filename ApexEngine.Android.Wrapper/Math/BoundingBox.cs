...
namespace ApexEngine.Math
{
    public class BoundingBox
    {
        ...
        private Vector3f max = new Vector3f(), min = new Vector3f(), center = new Vector3f();
        ...
        public BoundingBox CreateBoundingBox(Mesh mesh)
        {
            return CreateBoundingBox(mesh.vertices);
        }
        ...
        public BoundingBox CreateBoundingBox(List<Vertex> vertices)
        {
            ...
            this.Set(v_min.GetPosition(), v_max.GetPosition());
            return this;
        }
        ...
        {
            return Set(new Vector3f(0.0f), new Vector3f(0.0f));
        }
    }
}