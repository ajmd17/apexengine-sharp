...
void main()
{
    vec2 q = v_texCoord0.xy;
    vec2 p = (vec2(2.0)*v_texCoord0.xy-vec2(1.0));
    vec2 m = vec2(0.0);   /*step(0.0001,iMouse.z) * iMouse.xy/iResolution.xy;*/
